...
class Enemy(Ship):
    ...
    def draw_enemy(self, window):
        ...
        window.blit(number_label, (self.x + int(star_img.get_width() / 2) - 6, self.y + int(star_img.get_height() / 2) - 15,),)
...
def collide(obj1, obj2):
    ...
    return obj1.maks.overlap(obj2.maks, (offset_x, offset_y)) != None
...
# https://www.youtube.com/watch?v=XftLMLs7wW8&ab_channel=L%27Imp%C3%A9ratrice
